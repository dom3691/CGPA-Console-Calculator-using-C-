...
namespace myCGPA
{
    internal class testGpa
    {
        public  static void Main ( )
        {
            ...
            Console.WriteLine(" ----------------DECAGON GPA CALCULATOR------------------- ");
            Console.WriteLine(" Welcome, This Calculator will Help You Calculate your GPA ");
            Console.Write(" \n");
            Console.WriteLine(" How Many Course Do you Offer?:  ");
